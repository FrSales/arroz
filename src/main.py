...
- Casca gerada: {f"{casca_gerada:,}".replace(",", ".")} kg ({percentual_casca_arroz}% do arroz descascado)
- Farelo gerado: {f"{farelo_gerado:,}".replace(",", ".")} kg ({percentual_farelo_arroz}% do arroz descascado)
- Quirela gerada: {f"{quirela_gerada:,}".replace(",", ".")} kg ({percentual_quirela_arroz}% do arroz descascado)\n""")